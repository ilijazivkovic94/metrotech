...
return [
	...
	"sliders" => [
	"already_exists" => "That Slider already exists. Please choose a different name.",
	...
	"learnings" => [
	"already_exists" => "That Learning already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Learning. Please try again.",
	"delete_error" => "There was a problem deleting this Learning. Please try again.",
	"not_found" => "That Learning does not exist.",
	"update_error" => "There was a problem updating this Learning. Please try again.",
	],
	"homevideos" => [
	"already_exists" => "That HomeVideo already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this HomeVideo. Please try again.",
	"delete_error" => "There was a problem deleting this HomeVideo. Please try again.",
	"not_found" => "That HomeVideo does not exist.",
	"update_error" => "There was a problem updating this HomeVideo. Please try again.",
	],
	"teams" => [
	"already_exists" => "That Team already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Team. Please try again.",
	"delete_error" => "There was a problem deleting this Team. Please try again.",
	"not_found" => "That Team does not exist.",
	"update_error" => "There was a problem updating this Team. Please try again.",
	],
	"partners" => [
