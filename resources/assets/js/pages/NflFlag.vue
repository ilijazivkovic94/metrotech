                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="content-container">
                            <h3 style="text-shadow: 3px 1px 2px black;">NFL FLAG MADDEN NFL 20 TOURNAMENT</h3>
                            <span class="sub-title" style="text-shadow: 3px 1px 2px black;color: #d7df21;font-weight: bold;">NFL FLAG FOOTBALL Is Excited To Bring You Our First-Ever Madden NFL 20 Tournament</span>
                            <div style="margin-left: 100px;margin-top: 15px;">
                                <router-link  :to="{name:'db_register',params:{'entity_id': 40}, query:{flag:'tour'}}" class="btn btn-outline-success btn-transparent moving-inner" style="text-shadow: 3px 1px 2px black;">Register!</router-link>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: center;">
                        <div style="color: white; background-color: black;">
                            ...
                            <p style="font-weight: bold;">Live Streaming June 24th, 25th, and 26th</p>
                            <div style="height: 0px;  padding-bottom: 56.7%;">
                                <iframe frameborder="0" style="width: calc(100% - 30px);height: 100%;position: absolute;left: 15px;" allow="autoplay; encrypted-media" allowfullscreen="" data-src="https://www.youtube.com/embed/CR5-U6sRtRY" class="lazyloaded" src="https://www.youtube.com/embed/CR5-U6sRtRY"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 section_info" style="text-align: center;">
                        <h4>NFL FLAG FOOTBALL is excited to bring you our first-ever Madden NFL 20 Tournament.</h4>
                        <h4>NFL FLAG players from across the nation are invited to compete against each other in a virtual competition.</h4>
                ...
                <div class="row">
                    <div class="col-md-12 section_prize">
                        <div class="section_content">
                            ...
                            <div class="rank">
                                <h2 class="elementor-heading-title elementor-size-default">🥉Third Place</h2>
                                <h3 class="elementor-heading-title elementor-size-default">• $175 - $275 in NFL Store Credits</h3>
                                <h3 class="elementor-heading-title elementor-size-default"><a href="/coaching">• Metro Pro Esports Coaching Session!</a></h3>
                            </div>
                            <div class="rank">
                                <h2 class="elementor-heading-title elementor-size-default">🥈Second Place</h2>
                                <h3 class="elementor-heading-title elementor-size-default">• $450 in NFL Store Credits</h3>
                                <h3 class="elementor-heading-title elementor-size-default"><a href="/coaching">• 2x Metro Pro Esports Coaching Sessions!</a></h3>
                            </div>
                            <div class="rank">
                                <h2 class="elementor-heading-title elementor-size-default">🥇First Place</h2>
                                <h3 class="elementor-heading-title elementor-size-default">• $1000 in NFL Store Credits</h3>
                                <h3 class="elementor-heading-title elementor-size-default"><a href="/coaching">• 3x Metro Pro Esports Coaching Sessions!</a></h3>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 section_schedule">
                        <div class="section_schedule_content">
                            ...
                            <div class="rank">
                                <h3 class="elementor-heading-title elementor-size-default">Wednesday June 24th</h3>
                                <h3 class="elementor-heading-title elementor-size-default" style="font-weight: lighter;">Pool-Play from: 4pm EST</h3>
                            </div>
                            <div class="rank">
                                <h3 class="elementor-heading-title elementor-size-default">Thursday June 25th</h3>
                                <h3 class="elementor-heading-title elementor-size-default" style="font-weight: lighter;">Semi-Finals from: 4pm EST</h3>
                            </div>
                            <div class="rank">
                                <h3 class="elementor-heading-title elementor-size-default">Friday June 26th</h3>
                                <h3 class="elementor-heading-title elementor-size-default" style="font-weight: lighter;">Finals from: 4pm EST</h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="store-list-item">
                            <div>
                                <div class="team-container">
                                    ...
                                    <img src="https://doctorbattles.com/storage/parent-league-banner/5ec3e5acb72e7_1589896620.jpg"
                                         class="team-image">
                                </div>
                                <div class="info">
                                    <span class="name">NFL FLAG MADDEN 20</span>
                                    <div class="btn-wrap">
                                        <router-link class="btn btn-block small" :to="{name: 'db_register',params:{'entity_id': 40}, query:{flag:'tour'}}">REGISTER</router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                                           class="elementor-field elementor-field-textual elementor-size-md"></div>-->
