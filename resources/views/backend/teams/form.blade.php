<div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('team_link', null, ['class' => 'form-control box-size', 'placeholder' => trans('Partner Link'), 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
                        ...
                        <div class="img-remove-logo">
							@if(@$teams->image_link)
							<img height="50%" width="50%" src="{{ ('/storage/img/team/' . $teams->image_link) }}">
                    ...
                    <div class="col-lg-10">
                        <div class="control-group">
                            <label class="control control--checkbox">
                                {{ Form::checkbox('status', @$teams->status, @$teams->status) }}
