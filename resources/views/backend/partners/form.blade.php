<div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {{ Form::label('Partner Link', trans('Partner Link'), ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::text('partner_link', null, ['class' => 'form-control box-size', 'placeholder' => trans('Partner Link'), 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
                        ...
                        <div class="img-remove-logo">
							@if(@$partners->image_link)
							<img height="50%" width="50%" src="{{ ('/storage/img/partner/' . $partners->image_link) }}">
                    ...
                    <div class="col-lg-10">
                        <div class="control-group">
                            <label class="control control--checkbox">
                                {{ Form::checkbox('status', @$partners->status, @$partners->status) }}
