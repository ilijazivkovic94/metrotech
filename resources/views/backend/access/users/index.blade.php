        ...
        (function() {
            ...
            var dataTable = $('#users-table').dataTable({
                ...
                columns: [
                    ...
                    {data: 'school', name: '{{config('access.users_table')}}.school'},
                    {data: 'grade', name: '{{config('access.users_table')}}.grade'},
                    {data: 'organization', name: '{{config('access.users_table')}}.organization'},
                    {data: 'parent_full_name', name: '{{config('access.users_table')}}.parent_full_name'},
                    {data: 'parent_email', name: '{{config('access.users_table')}}.parent_email'},
                    {data: 'xbox', name: '{{config('access.users_table')}}.xbox'},
                    {data: 'd_o_b', name: '{{config('access.users_table')}}.d_o_b'},
                    {data: 'psn_id', name: '{{config('access.users_table')}}.psn_id'},
