...
<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('desc', null, ['class' => 'form-control box-size', 'placeholder' => trans('Slider Description'), 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <div class="form-group">
                    {{ Form::label('Slider Name', trans('Slider Name'), ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::text('slider_name', null, ['class' => 'form-control box-size', 'placeholder' => trans('Slider Name'), 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                <div class="form-group">
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
                        ...
                        <div class="img-remove-logo">
							@if(@$sliders->image_link)
							<img height="50%" width="50%" src="{{ ('/storage/img/slider/' . $sliders->image_link) }}">
                    ...
                    <div class="col-lg-10">
                        <div class="control-group">
                            <label class="control control--checkbox">
                                {{ Form::checkbox('status', @$sliders->status, @$sliders->status) }}
