<!--Action Button-->
@if( Active::checkUriPattern( 'admin/learnings' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.learnings.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.learnings.all' ) }}
            </a>
        </li>
        @permission( 'create-learning' )
            <li>
                <a href="{{ route( 'admin.learnings.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.learnings.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
