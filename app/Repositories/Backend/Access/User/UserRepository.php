    ...
    public function getForDataTable($status = 1, $trashed = false)
    {
        ...
        $dataTableQuery = $this->query()
            ...
            ->select([
                ...
                config('access.users_table').'.school',
                config('access.users_table').'.grade',
                config('access.users_table').'.organization',
                config('access.users_table').'.parent_full_name',
                config('access.users_table').'.parent_email',
                config('access.users_table').'.xbox',
                config('access.users_table').'.d_o_b',
                config('access.users_table').'.psn_id',
