...
class ModulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $modules = [
            ...
            [
                'name'                  => trans('menus.backend.sliders.management'),
                'url'                   => 'admin.sliders.index',
                'view_permission_id'    => 'view-slider',
                'created_by'            => 1,
                'created_at'            => Carbon::now(),
            ],
            [
                'name'                  => trans('menus.backend.learnings.management'),
                'url'                   => 'admin.learnings.index',
                'view_permission_id'    => 'view-learning',
                'created_by'            => 1,
                'created_at'            => Carbon::now(),
            ],
            [
                'name'                  => trans('menus.backend.homevideos.management'),
                'url'                   => 'admin.homevideos.index',
                'view_permission_id'    => 'view-homevideo',
                'created_by'            => 1,
                'created_at'            => Carbon::now(),
            ],
            [
                'name'                  => trans('menus.backend.teams.management'),
                'url'                   => 'admin.teams.index',
                'view_permission_id'    => 'view-team',
                'created_by'            => 1,
                'created_at'            => Carbon::now(),
            ],
            [
                ...
                'view_permission_id'    => 'view-partner',
                'created_by'            => 1,
                'created_at'            => Carbon::now(),
            ],
        ];
